...
const QuestionsSection = ({mockInterviewQuestion,activeQuestionIndex}: Props) => { 
  ...
  return (
    ...
    <div className='p-5 border rounded-lg mb-5'>
        ...
        <div className='border rounded-lg p-5 bg-blue-100 mt-10 '>
            <h2 className='flex gap-2 items-center text-[#088395]'> 
                <Lightbulb/>
                <strong>Note:</strong>
            </h2>
            <h2 className='text-sm text-[#088395] my-2'>{process.env.NEXT_PUBLIC_QUESTION_NOTE}</h2>
        </div>
    </div>
  )
 )}
