...
const page = ({ params }: Props) => {
  ...
  return (
    <div className="my-4 ">
      <h2 className="font-bold text-2xl mb-4 text-[#37B7C3]">
        Let's Get Started
      </h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        <div className="flex flex-col gap-5 ">
          ...
          <div className="p-6  bg-blue-100 rounded-lg ">
            <h2 className="flex gap-2 items-center text-[#37B7C3]">
              {" "}
              <Lightbulb />
              <strong>Information</strong>
            </h2>
            <h2 className="mt-3  text-[#37B7C3]">
        ...
        <div className="flex flex-col items-center justify-center ">
          {webCamEnabled ? (
            ...
            <>
              ...
              <Button
                className="w-full bg-[#088395] mt-4 mb-4"
